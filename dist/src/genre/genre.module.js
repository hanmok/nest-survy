...
let GenreModule = exports.GenreModule = class GenreModule {
};
exports.GenreModule = GenreModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([genre_entity_1.Genre, user_genre_entity_1.UserGenre, survey_genre_entity_1.SurveyGenre])],
        providers: [genre_service_1.GenreService, survey_genre_service_1.SurveyGenreService],
