...
const createAnswer_dto_1 = require("./createAnswer.dto");
...
let AnswerController = exports.AnswerController = class AnswerController {
    ...
    async getAnswers(survey_id) {
        return await this.answerService.getAnswerBySurveyId(survey_id);
    }
};
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'Create Answer' }),
    (0, common_2.Post)(),
...
__decorate([
    (0, swagger_1.ApiOperation)({ summary: 'testing' }),
    (0, common_2.Get)(),
    __param(0, (0, common_2.Query)('survey_id')),
    __metadata("design:type", Function),
